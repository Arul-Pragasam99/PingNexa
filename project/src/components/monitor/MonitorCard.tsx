    ...
    <div style={{ fontFamily: "'Lato', sans-serif" }} className="glass-card glow-border rounded-2xl px-5 py-4 flex items-center gap-4 group">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {monitor.notesOrTag && (
            <span className="px-2 py-0.5 rounded-full bg-accent/10 text-accent text-[10px] font-mono border border-accent/20 flex-shrink-0">
              {monitor.notesOrTag}
            </span>
          )}
        </div>
        <div className="font-mono text-xs text-text-muted truncate mt-0.5">{monitor.url}</div>
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        <button
          ...
          className="p-2 rounded-lg text-text-muted hover:text-warn hover:bg-warn/10 transition-all opacity-0 group-hover:opacity-100"
        >
        ...
        <button
          ...
          title="Settings"
          className="p-2 rounded-lg text-text-muted hover:text-accent hover:bg-accent/10 transition-all opacity-0 group-hover:opacity-100"
        >
        ...
        <button
          onClick={() => onOpenDetail(monitor.id)}
          className="p-2 rounded-lg text-text-muted hover:text-text hover:bg-card transition-all"
        >
